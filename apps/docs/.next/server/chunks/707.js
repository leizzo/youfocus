...
var _head = _interop_require_default(__webpack_require__(7016));
...
var _addLocale = __webpack_require__(7003);
var _routerContext = __webpack_require__(4964);
var _appRouterContext = __webpack_require__(3280);
var _useIntersection = __webpack_require__(8599);
var _getDomainLocale = __webpack_require__(2219);
var _addBasePath = __webpack_require__(2484);
...
var _hasBasePath = __webpack_require__(7178);
const basePath =  false || "";
...
var _trustedTypes = __webpack_require__(8958);
...
var _script = __webpack_require__(4271);
...
var _formatUrl = __webpack_require__(3938);
var _detectDomainLocale = __webpack_require__(7384);
var _parsePath = __webpack_require__(8854);
var _addLocale = __webpack_require__(7003);
var _removeLocale = __webpack_require__(9293);
var _removeBasePath = __webpack_require__(33);
var _addBasePath = __webpack_require__(2484);
var _hasBasePath = __webpack_require__(7178);
var _isApiRoute = __webpack_require__(4219);
...
/* unused reexport */ __webpack_require__(6239)
...
/* harmony import */ var next_package_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8526);
/* harmony import */ var next_link__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9097);
...
/* harmony import */ var nextra_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1181);
/* harmony import */ var git_url_parse__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(9164);
...
/* harmony import */ var _popperjs_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(3841);
...
/* harmony import */ var flexsearch__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(8395);
...
/* harmony import */ var _headlessui_react__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(1185);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(6405);
...
/* harmony import */ var next_dist_client_add_base_path__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(2484);
...
/* harmony import */ var next_seo__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(6641);
...
/* harmony import */ var github_slugger__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(1578);
/* harmony import */ var scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(8751);
/* harmony import */ var match_sorter__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(5875);
/* harmony import */ var match_sorter__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(match_sorter__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var zod__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(9926);
/* harmony import */ var intersection_observer__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(4916);
/* harmony import */ var intersection_observer__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(intersection_observer__WEBPACK_IMPORTED_MODULE_23__);
/* harmony import */ var nextra_components__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(9081);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([nextra_mdx__WEBPACK_IMPORTED_MODULE_4__, nextra_hooks__WEBPACK_IMPORTED_MODULE_5__, nextra_icons__WEBPACK_IMPORTED_MODULE_10__, _headlessui_react__WEBPACK_IMPORTED_MODULE_14__, github_slugger__WEBPACK_IMPORTED_MODULE_19__, scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_20__, zod__WEBPACK_IMPORTED_MODULE_22__, nextra_components__WEBPACK_IMPORTED_MODULE_24__]);
([nextra_mdx__WEBPACK_IMPORTED_MODULE_4__, nextra_hooks__WEBPACK_IMPORTED_MODULE_5__, nextra_icons__WEBPACK_IMPORTED_MODULE_10__, _headlessui_react__WEBPACK_IMPORTED_MODULE_14__, github_slugger__WEBPACK_IMPORTED_MODULE_19__, scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_20__, zod__WEBPACK_IMPORTED_MODULE_22__, nextra_components__WEBPACK_IMPORTED_MODULE_24__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
var theme;
var isValidated = "production" === "production";
...
var ConfigProvider = ({
  ...
  if (!isValidated) {
    try {
      ...
      console.error(
        err.issues.map(
          (issue) => "[nextra] Error in config `" + issue.path.join(".") + "`: " + lowerCaseFirstLetter(issue.message || "")
        ).join("\n")
      );
    }
    isValidated = true;
...
function Search({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    onActive == null ? void 0 : onActive(show);
  }, [show, onActive]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const down = (e) => {
      var _a;
    ...
    children: [
      ...
      /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_headlessui_react__WEBPACK_IMPORTED_MODULE_14__.Transition, {
        ...
        children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("ul", {
          ...
          children: loading ? /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("span", {
...
function FolderImpl({
  ...
  const open = TreeState[item.route] !== void 0 ? TreeState[item.route] || focusedRouteInside : active || activeRouteInside || focusedRouteInside || (theme2 && "collapsed" in theme2 ? !theme2.collapsed : level < config.sidebar.defaultMenuCollapseLevel);
...
function File({
  ...
  const slugger = new github_slugger__WEBPACK_IMPORTED_MODULE_19__["default"]();
...
function Sidebar({
  ...
  const anchors = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(
    () => headings.filter((v) => v.depth === 2).map(getHeadingText).filter(Boolean),
    [headings]
  );
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (activeElement && (window.innerWidth > 767 || menu)) {
      const scroll = () => {
        (0,scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_20__["default"])(activeElement, {
          block: "center",
          inline: "center",
          scrollMode: "always",
...
function TOC({ headings, filePath }) {
  var _a;
  const sluggerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  sluggerRef.current || (sluggerRef.current = new github_slugger__WEBPACK_IMPORTED_MODULE_19__["default"]());
  const activeAnchor = useActiveAnchor();
  const config = useConfig();
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (anchor) {
      (0,scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_20__["default"])(anchor, {
        behavior: "smooth",
        block: "center",
        inline: "center",
        scrollMode: "always",
      ...
      hasHeadings && /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
        children: [
          ...
          /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("ul", {
            children: items.map(({ slug, text, depth }) => {
              var _a2;
              return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("li", {
...
function MatchSorterSearch({
  ...
  const results = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(
    () => search ? (0,match_sorter__WEBPACK_IMPORTED_MODULE_21__.matchSorter)(directories, search, { keys: ["title"] }).map(
      ({ route, title }) => ({
        id: route + title,
        route,
        children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(HighlightMatches, {
...
var i18nSchema = zod__WEBPACK_IMPORTED_MODULE_22__.z.array(
  zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
...
var themeSchema = zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
  banner: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
  ...
  chat: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
  ...
  editLink: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
  ...
  feedback: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
  ...
  footer: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
  ...
  navbar: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
    component: zod__WEBPACK_IMPORTED_MODULE_22__.z.custom(...reactNode),
  ...
  nextThemes: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
  ...
  notFound: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
    content: zod__WEBPACK_IMPORTED_MODULE_22__.z.custom(...reactNode),
    labels: zod__WEBPACK_IMPORTED_MODULE_22__.z.string()
  }),
  ...
  project: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
    icon: zod__WEBPACK_IMPORTED_MODULE_22__.z.custom(...reactNode),
    link: zod__WEBPACK_IMPORTED_MODULE_22__.z.string().startsWith("https://").optional()
  }),
  search: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
    component: zod__WEBPACK_IMPORTED_MODULE_22__.z.custom(...reactNode),
  ...
  serverSideError: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
    content: zod__WEBPACK_IMPORTED_MODULE_22__.z.custom(...reactNode),
    labels: zod__WEBPACK_IMPORTED_MODULE_22__.z.string()
  }),
  sidebar: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
  ...
  toc: zod__WEBPACK_IMPORTED_MODULE_22__.z.object({
    component: zod__WEBPACK_IMPORTED_MODULE_22__.z.custom(...reactNode),
...
var getComponents = ({
  ...
  return __spreadValues({
    ...
    table: (props) => /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(nextra_components__WEBPACK_IMPORTED_MODULE_24__.Table, __spreadValues({
...
function useDirectoryInfo(pageMap) {
  const { locale = DEFAULT_LOCALE, defaultLocale, asPath } = (0,next_router__WEBPACK_IMPORTED_MODULE_1__.useRouter)();
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
...
var Body = ({
  ...
  if (themeContext.layout === "full") {
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("article", {
      className: "nextra-content nx-min-h-[calc(100vh-4rem)] nx-w-full nx-overflow-x-hidden nx-pl-[max(env(safe-area-inset-left),1.5rem)] nx-pr-[max(env(safe-area-inset-right),1.5rem)]",
      children: body
    });
  }
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("article", {
...
var tocClassName = clsx__WEBPACK_IMPORTED_MODULE_3___default()(
